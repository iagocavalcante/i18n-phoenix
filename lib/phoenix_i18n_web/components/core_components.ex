defmodule PhoenixI18nWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixI18nWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixI18nWeb.Gettext, "errors", msg, opts)
    end
  end
